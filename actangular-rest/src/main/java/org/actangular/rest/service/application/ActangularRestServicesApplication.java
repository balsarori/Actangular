 ...
 * 
 */
public class ActangularRestServicesApplication extends ActivitiRestServicesApplication {

  @Override
  public void initializeAuthentication() {
    authenticator = new ChallengeAuthenticator(null, true, ChallengeScheme.CUSTOM, "Actangular Realm") {
  ...
  public synchronized Restlet createInboundRoot() {
    //register a an authenticator helper to avoid warning log
    Engine.getInstance().getRegisteredAuthenticators().add(new AuthenticatorHelper(ChallengeScheme.CUSTOM, true, true) {});
